const firstSide = Number(prompt(`Input first side of triangle`, `3`));
const secondSide = Number(prompt(`Input second side of triangle`, `4`));
const thirdSide = Number(prompt(`Input third side of triangle`, `5`));
let type;
